Vue.component("manager-trainings", {
    ...
    <div v-if="trainings">
      ...
      <h2>Trainings</h2>
      <div>
        <select name="sel2" @change="searchTable($event)">
      ...
      <div class="float-right">
            <select name="sel1" @change="sortTable($event)">
                <option :value="col.name" v-for="col in sortColumns">{{col.name}}</option>
            </select>      
      </div>
      
      <div class="float-right">
            <select name="sel3" @change="sortOrder($event)">
      ...
      <div class="position-relative">
            <span class="position-absolute search"><i class="fa fa-search"></i></span>
            <input class="form-control w-100" @input="filterTable()" v-model="filterBy" style="border:4px solid #e3f2fd;"
    ...
    methods:{
        ...
        sortTable(event){
            axios
                .get('rest/sort/trainer-trainings', {params: {
